...
$MESS['SENDER_SUBSCR_NOTE_CONFIRM']='Вам выслано письмо. Для подтверждения перейдите по ссылке из письма';
$MESS['SENDER_SUBSCR_ERR_SECURITY']='При попытке подтвердить подписку произошла ошибка. Неверный URL.';
$MESS['ROBOT_DETECTED'] = "Вы распознаны как робот";